...
const LIMITS = [
  ...
  { id: "tach-normal", unit: "RPM", row: "Tachometer", col: "Normal", ask: "Tachometer — normal range", a: "2100-2450 RPM" },
  { id: "tach-max", unit: "RPM", row: "Tachometer", col: "Max", ask: "Tachometer — maximum", a: "2700 RPM" },
  { id: "oilt-normal", unit: "°F", row: "Oil Temp", col: "Normal", ask: "Oil temperature — normal range", a: "100-245 °F" },
  { id: "oilt-max", unit: "°F", row: "Oil Temp", col: "Max", ask: "Oil temperature — maximum", a: "245 °F" },
  { id: "oilp-min", unit: "PSI", row: "Oil Press", col: "Min", ask: "Oil pressure — minimum", a: "25 PSI" },
  { id: "oilp-normal", unit: "PSI", row: "Oil Press", col: "Normal", ask: "Oil pressure — normal range", a: "60-90 PSI" },
  { id: "oilp-max", unit: "PSI", row: "Oil Press", col: "Max", ask: "Oil pressure — maximum", a: "115 PSI" },
  { id: "oilq-min", unit: "qts", row: "Oil Quantity", col: "Min", ask: "Oil quantity — minimum", a: "6 qts" },
  { id: "oilq-normal", unit: "qts", row: "Oil Quantity", col: "Normal", ask: "Oil quantity — normal range", a: "6-7 qts" },
  { id: "oilq-max", unit: "qts", row: "Oil Quantity", col: "Max", ask: "Oil quantity — maximum", a: "8 qts" },
  { id: "carb-caution", unit: "°C", row: "Carb. Air Temp", col: "Caution", ask: "Carburetor air temperature — caution range", a: "-15 to 5 °C" },
  { id: "starter", unit: "", row: "Starter Duty Cycle", col: "wide", ask: "Starter duty cycle", a: "Crank 10 sec, Cool 20 sec, after 3 cycles 10 min cooling", words: ["crank", "cool", "cycles", "cooling"] },
  // Single-value limits
  { id: "max-weight", unit: "lbs", row: "Max Weight", col: "single", ask: "Maximum gross weight", a: "2550 lbs" },
  { id: "baggage", unit: "lbs", row: "Baggage Allowance", col: "single", ask: "Baggage allowance", a: "120 lbs" },
  { id: "fuel", unit: "gal", row: "Fuel Capacity", col: "single", ask: "Fuel capacity", a: "43 gal" },
  { id: "xwind", unit: "kts", row: "Max Crosswind", col: "single", ask: "Maximum crosswind component", a: "15 kts" },
  { id: "aob", unit: "°", row: "Max Angle of Bank", col: "single", ask: "Maximum angle of bank", a: "60°" },
  { id: "ceiling", unit: "ft", row: "Service Ceiling", col: "single", ask: "Service ceiling", a: "14,200 ft" },
  { id: "wingspan", unit: "ft", row: "Wingspan", col: "single", ask: "Wingspan", a: "36 ft" },
  { id: "llf-up", unit: "Gs", row: "Limit Load Factors: Flaps Up", col: "single", ask: "Limit load factors — flaps up", a: "3.8 to -1.52 Gs" },
  { id: "llf-down", unit: "Gs", row: "Limit Load Factors: Flaps Down", col: "single", ask: "Limit load factors — flaps down", a: "3 to 0 Gs" },
  // V-speeds
  { id: "vne", unit: "KIAS", row: "V<sub>NE</sub>", plain: "VNE", col: "single", ask: "V<sub>NE</sub> (never exceed)", a: "158 KIAS" },
  { id: "vno", unit: "KIAS", row: "V<sub>NO</sub>", plain: "VNO", col: "single", ask: "V<sub>NO</sub> (max structural cruising)", a: "127 KIAS" },
  { id: "va", unit: "KIAS", row: "V<sub>A</sub>", plain: "VA", col: "single", ask: "V<sub>A</sub> (maneuvering)", a: "105 KIAS" },
  { id: "vfe", unit: "KIAS", row: "V<sub>FE</sub>", plain: "VFE", col: "single", ask: "V<sub>FE</sub> (max flaps extended)", a: "85 KIAS" },
  { id: "vy", unit: "KIAS", row: "V<sub>Y</sub>", plain: "VY", col: "single", ask: "V<sub>Y</sub> (best rate of climb)", a: "73 KIAS" },
  { id: "vx", unit: "KIAS", row: "V<sub>X</sub>", plain: "VX", col: "single", ask: "V<sub>X</sub> (best angle of climb)", a: "62 KIAS" },
  { id: "vglide", unit: "KIAS", row: "V<sub>glide</sub>", plain: "Vglide", col: "single", ask: "V<sub>glide</sub> (best glide)", a: "68 KIAS" },
  { id: "vr", unit: "KIAS", row: "V<sub>R</sub>", plain: "VR", col: "single", ask: "V<sub>R</sub> (rotation)", a: "55 KIAS" },
  { id: "vs", unit: "KIAS", row: "V<sub>S</sub>", plain: "VS", col: "single", ask: "V<sub>S</sub> (stall, clean)", a: "50 KIAS" },
  { id: "vso", unit: "KIAS", row: "V<sub>SO</sub>", plain: "VSO", col: "single", ask: "V<sub>SO</sub> (stall, landing configuration)", a: "40 KIAS" },
];
